...
class SignUpDriverDocumentScreen extends StatefulWidget {
  bool isForceFullyAdd;

  SignUpDriverDocumentScreen({this.isForceFullyAdd = false});

  @override
  _SignUpDriverDocumentScreenState createState() => _SignUpDriverDocumentScreenState();
}

class _SignUpDriverDocumentScreenState extends State<SignUpDriverDocumentScreen> {
